...
export default function TV() {
  ...
  for (let i = 0; i < 10; i++) {
    divArr.push({
      src: "/assets/images/prof.jpg",
      alt: "hero",
      overview: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro non sed maxime praesentium esse pariatur? Animi ut minima vero voluptatibus reprehenderit repellat neque iusto, eligendi culpa, rem nihil tempora?Ipsam!",
    });
  }
  return (
    <div className="w-full h-full">
      ...
      >
        <div className="text-lg text-center h-full w-full p-2 md:flex flex-col md:flex-row items-center justify-between">
          <div>
            <div className="text-6xl">ShowName</div>
      ...
      <div className="w-full h-full p-7">
        <div className="border-2 rounded-lg p-2 gap-5 flex flex-col">
          ...
          <div>
            ...
            <div>
              <DivSlider arr={divArr}/>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 bg-gray-200 p-4 py-2 rounded-lg">
            <span className="bg-white p-2 py-1 shadow-inner text-lg w-fit">
              146min.
            </span>
            <span className="bg-white p-2 py-1 shadow-inner text-lg w-fit">
              EN ES
